...
echo   6. Test specific pages like Requirements.php, Navigating-The-User-Interface.php, Principles-of-Operation.php, Graph-Overview.php, How-to-Graph-Your-Network.php, and Viewing-Graphs.php
