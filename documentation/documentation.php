...
<li><a href="Settings-Device-Defaults.php"><?php _e('settings_device_defaults'); ?></a></li>
<li><a href="Settings-Poller.php"><?php _e('settings_poller'); ?></a></li>
<li><a href="Settings-Data.php"><?php _e('settings_data'); ?></a></li>
<li><a href="Settings-Visual.php"><?php _e('settings_visual'); ?></a></li>
<li><a href="Settings-Performance.php"><?php _e('settings_performance'); ?></a></li>
<li><a href="Settings-Spikes.php"><?php _e('settings_spikes'); ?></a></li>
<li><a href="Settings-Mail-Reporting-DNS.php"><?php _e('settings_mail_reporting_dns'); ?></a></li>
</ul>

<h4 id="settings-auth"><?php _e('settings_auth'); ?></h4>
<ul>
<li><a href="Settings-Auth-Local.php"><?php _e('settings_auth_local'); ?></a></li>
<li><a href="Settings-Auth-LDAP.php"><?php _e('settings_auth_ldap'); ?></a></li>
<li><a href="Settings-Auth-Basic.php"><?php _e('settings_auth_basic'); ?></a></li>
<li><a href="Settings-Domains.php"><?php _e('settings_domains'); ?></a></li>
</ul>
...
<li><a href="User-Group-Management.php"><?php _e('user_group_management'); ?></a></li>
<li><a href="User-Domains.php"><?php _e('user_domains'); ?></a></li>
</ul>

<h3 id="plugins"><?php _e('configuration_plugins'); ?></h3>
<ul>
<li><a href="Plugin-Management.php"><?php _e('plugin_management'); ?></a></li>
</ul>

<h3 id="utilities"><?php _e('utilities'); ?></h3>
<ul>
<li><a href="System-Utilities.php"><?php _e('system_utilities'); ?></a></li>
<li><a href="Data-Debug.php"><?php _e('data_debug'); ?></a></li>
<li><a href="External-Links.php"><?php _e('external_links'); ?></a></li>
</ul>

<h3 id="reporting"><?php _e('reporting'); ?></h3>
<ul>
<li><a href="Reports-Admin.php"><?php _e('reports_admin'); ?></a></li>
<li><a href="Reports-User.php"><?php _e('reports_user'); ?></a></li>
<li><a href="Reports-Items.php"><?php _e('reports_items'); ?></a></li>
<li><a href="Reports-Preview.php"><?php _e('reports_preview'); ?></a></li>
<li><a href="Reports-Events.php"><?php _e('reports_events'); ?></a></li>
<li><a href="Reports-Other-Options.php"><?php _e('reports_other_options'); ?></a></li>
</ul>

<h3 id="other-advanced"><?php _e('other_advanced_topics'); ?></h3>
<ul>
<li><a href="Cacti-Log.php"><?php _e('cacti_log'); ?></a></li>
<li><a href="Command-Line-Scripts.php"><?php _e('command_line_scripts'); ?></a></li>
<li><a href="PHP-Script-Server.php"><?php _e('php_script_server'); ?></a></li>
<li><a href="Boost.php"><?php _e('boost'); ?></a></li>
<li><a href="Frequently-Asked-Questions.php"><?php _e('frequently_asked_questions'); ?></a></li>
<li><a href="Variables.php"><?php _e('replacement_variables'); ?></a></li>
<li><a href="RRDtool-Specific-Features.php"><?php _e('rrdtool_specific_features'); ?></a></li>
<li><a href="RRDproxy.php"><?php _e('rrdproxy_specific_features'); ?></a></li>
<li><a href="Spikekill.php"><?php _e('spikekill'); ?></a></li>
<li><a href="Debugging.php"><?php _e('debugging'); ?></a></li>
<li><a href="Version-Specific-Release-Notes.php"><?php _e('version_specific_release_notes'); ?></a></li>
</ul>
...
<ul>
<li><a href="Plugin-Overview.php"><?php _e('plugin_overview'); ?></a></li>
<li><a href="Plugin-Guidelines.php"><?php _e('plugin_guidelines'); ?></a></li>
<li><a href="Creating-Plugins.php"><?php _e('creating_plugins'); ?></a></li>
<li><a href="Plugin-References.php"><?php _e('plugin_references'); ?></a></li>
<li><a href="Plugin-Hook-API-Ref.php"><?php _e('plugin_hook_api_ref'); ?></a></li>
</ul>

<h3 id="supported-plugins"><?php _e('supported_plugins'); ?></h3>
<ul>
<li><a href="Syslog-Plugin.php"><?php _e('syslog_plugin'); ?></a></li>
<li><a href="Mactrack-Plugin.php"><?php _e('mactrack_plugin'); ?></a></li>
<li><a href="ReportIt-Plugin.php"><?php _e('reportit_plugin'); ?></a></li>
</ul>
...
<ul>
<li><a href="How-To-Work-with-Templates.php"><?php _e('how_to_work_with_templates'); ?></a></li>
<li><a href="How-To-Create-Data-Input-Method.php"><?php _e('how_to_create_data_input_method'); ?></a></li>
<li><a href="How-To-Data-Queries.php"><?php _e('how_to_data_queries'); ?></a></li>
<li><a href="How-To-Existing-SNMP-Data-Queries.php"><?php _e('how_to_existing_snmp_data_queries'); ?></a></li>
<li><a href="How-To-New-SNMP-Data-Queries.php"><?php _e('how_to_new_snmp_data_queries'); ?></a></li>
<li><a href="How-To-Script-Data-Queries.php"><?php _e('how_to_script_data_queries'); ?></a></li>
<li><a href="How-To-Setup-Remote-Pollers.php"><?php _e('how_to_setup_remote_pollers'); ?></a></li>
<li><a href="How-To-Determine-Template-Version.php"><?php _e('how_to_determine_template_version'); ?></a></li>
<li><a href="How-To-SSH-Tunnels.php"><?php _e('how_to_ssh_tunnels'); ?></a></li>
<li><a href="Enable-SSL-for-Cacti.php"><?php _e('enable_ssl_for_cacti'); ?></a></li>
<li><a href="Graph-a-Single-SNMP-OID.php"><?php _e('graph_single_snmp_oid'); ?></a></li>
<li><a href="How-To-snmpd-custom-script.php"><?php _e('how_to_snmp_custom_script'); ?></a></li>
<li><a href="How-To-poller-5-to-1-min.php"><?php _e('how_to_poller_5_to_1_min'); ?></a></li>
<li><a href="Convert-package-to-source.php"><?php _e('convert_package_to_source'); ?></a></li>
</ul>
...
<ul>
<li><a href="Open-Source-Code.php"><?php _e('open_source_code'); ?></a></li>
<li><a href="Language-Translations.php"><?php _e('language_translations'); ?></a></li>
</ul>
...
<ul>
<li><a href="Standards-Documentation.php"><?php _e('standards_documentation'); ?></a></li>
<li><a href="Standards-Code-Formatting.php"><?php _e('standards_code_formatting'); ?></a></li>
<li><a href="Standards-PHP-Spec-Constructs.php"><?php _e('standards_php_spec_constructs'); ?></a></li>
<li><a href="Standards-FileSystem-Layout.php"><?php _e('standards_filesystem_layout'); ?></a></li>
<li><a href="Standards-Patch-Creation.php"><?php _e('standards_patch_creation'); ?></a></li>
<li><a href="Standards-SQL.php"><?php _e('standards_sql'); ?></a></li>
<li><a href="Standards-Security.php"><?php _e('standards_security'); ?></a></li>
</ul>
...
<ul>
<li><a href="Apache-Server-Template.php"><?php _e('apache_server_template'); ?></a></li>
<li><a href="ESXi-VMWare-Template.php"><?php _e('esxi_vmware_template'); ?></a></li>
</ul>
