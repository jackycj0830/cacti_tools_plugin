...
chmod u+s /usr/local/spine/bin/spine',
    ...
    // Additional documentation sections from documentation.html
    'settings_without_auth' => 'Settings (w/o Auth)',
    'settings_general' => 'General',
    'settings_paths' => 'Paths',
    'settings_device_defaults' => 'Device Defaults',
    'settings_poller' => 'Poller',
    ...
    'settings_performance' => 'Performance',
    'settings_spikes' => 'Spikes',
    'settings_mail_reporting_dns' => 'Mail/Reporting/DNS',
    'settings_auth' => 'Settings - Auth',
    'settings_auth_local' => 'Local Auth',
    'settings_auth_ldap' => 'LDAP Auth',
    'settings_auth_basic' => 'Basic Auth',
    'settings_domains' => 'Domains Auth',
    'configuration_users_groups_domains' => 'Configuration - Users, Groups and Domains',
    'user_management' => 'Users',
    'user_group_management' => 'User Groups',
    'user_domains' => 'User Domains',
    'configuration_plugins' => 'Configuration - Plugins',
    'utilities' => 'Utilities',
    'system_utilities' => 'System Utilities',
    'data_debug' => 'Data Debug',
    'external_links' => 'External Links',
    ...
    'reports_preview' => 'Report Preview Page',
    'reports_events' => 'Report Events Page',
    'reports_other_options' => 'Other Options for Adding Report Items',
    'cacti_log' => 'The Cacti Log',
    'command_line_scripts' => 'Command Line Scripts',
    'php_script_server' => 'PHP Script Server',
    'boost' => 'Performance Setting (Boost)',
    'frequently_asked_questions' => 'Frequently Asked Questions',
    'replacement_variables' => 'Replacement Variables',
    'rrdtool_specific_features' => 'RRDtool Specific Features',
    'rrdproxy_specific_features' => 'RRDProxy Specific Features',
    'spikekill' => 'Spikekill',
    'debugging' => 'Debugging',
    'version_specific_release_notes' => 'Version Specific Release Notes',
    'plugin_overview' => 'Plugin Overview',
    'plugin_guidelines' => 'Plugin Guidelines',
    'creating_plugins' => 'Creating Plugins',
    'plugin_references' => 'References',
    'plugin_hook_api_ref' => 'Hook API Reference',
    'supported_plugins' => 'Supported Plugins',
    'syslog_plugin' => 'Syslog Plugin documentation',
    'mactrack_plugin' => 'Mactrack Plugin documentation',
    'reportit_plugin' => 'ReportIt Plugin documentation',

    // How To's section
    'how_to_work_with_templates' => 'How To Work with Templates',
    'how_to_create_data_input_method' => 'How To Create a Data Input Method',
    'how_to_data_queries' => 'How To Work with Data Queries',
    'how_to_existing_snmp_data_queries' => 'How To Work with Existing SNMP Data Queries',
    'how_to_new_snmp_data_queries' => 'How To Work with New SNMP Data Queries',
    'how_to_script_data_queries' => 'How To Work with Script Data Queries',
    'how_to_setup_remote_pollers' => 'How To Setup Remote Pollers',
    'how_to_determine_template_version' => 'How To Determine Template Version',
    'how_to_ssh_tunnels' => 'How To Setup SSH Tunnels',
    'enable_ssl_for_cacti' => 'Enable SSL for Cacti',
    'graph_single_snmp_oid' => 'Graph a Single SNMP OID',
    'how_to_snmp_custom_script' => 'How To Extend snmpd with custom script/data',
    'how_to_poller_5_to_1_min' => 'Change poller interval from 5 minutes to 1 minute',
    'convert_package_to_source' => 'Convert from Package based install to source on Ubuntu/Debian',

    // Video Tutorials
    'video_tutorials' => 'Video Tutorials',
    'video_tutorials_desc' => 'Watch Howto\'s and Tutorials on the Cacti Official YouTube page if you prefer. If you would have any ideas for videos or would like to contribute let us know !',
    'cacti_youtube_channel' => 'Cacti Official Youtube Channel',
    ...
    'standards_documentation' => 'Documentation',
    'standards_code_formatting' => 'Code Formatting',
    'standards_php_spec_constructs' => 'PHP Specific Constructs',
    'standards_filesystem_layout' => 'File System Layout',
    'standards_patch_creation' => 'Patch Creation',
    'standards_sql' => 'SQL Standards',
    'standards_security' => 'Security',

    // Template Specific Documentation
    'template_specific_documentation' => 'Template Specific Documentation',
    'template_specific_desc' => 'This section will be for template specific configuration requirements',
    'apache_server_template' => 'Apache Server Template',
    'esxi_vmware_template' => 'ESXi/VMWare Template',

    // Additional missing keys
    'other_advanced_topics' => 'Other Advanced Topics',
    'plugin_management' => 'Plugin Management',

    // Settings General page specific
    'page_title_settings_general' => 'Cacti - General Settings',
    'settings_general_title' => 'General Settings',
    'settings_general_intro' => 'General Settings in Cacti consist of the following categories:',
    'log_settings' => 'Log Settings',
    'log_settings_desc' => 'This is where you setup Cacti\'s logging',
    'internationalization' => 'Internationalization (i18n)',
    'internationalization_desc' => 'Settings around how Cacti handles languages other than English',
    'other_settings' => 'Other Settings',
    'other_settings_desc' => 'Other not object settings in Cacti',
    'site_security' => 'Site Security',
    'site_security_desc' => 'Web Site Security settings such as Content-Security-Policy, use of external JavaScript API\'s for plugins like Google Maps, forcing https, etc.',
    'automation_settings' => 'Automation',
    'automation_settings_desc' => 'Miscellaneous settings around Cacti\'s Automation',
    'graph_template_defaults' => 'Graph Template Defaults',
    'graph_template_defaults_desc' => 'Defaults for Graph Templates',
    'settings_documented_below' => 'Each of these settings will be documented below.',

    // Log Settings
    'log_settings_intro' => 'Cacti has the ability to log at various levels for various files. It has the ability to log to both the standard cacti.log file, as well as sending some notifications to Syslog for forwarding to centralized logging servers. The image below show what this settings sub-tab section looks like:',
    'log_settings_include' => 'Those settings include:',
    'log_destination' => 'Log Destination',
    'log_destination_desc' => 'Where to place Cacti log output. Options include:',
    'logfile_only' => 'Logfile Only',
    'logfile_only_desc' => 'Only send log data to the Cacti log file',
    'logfile_and_syslog' => 'Logfile and Syslog',
    'logfile_and_syslog_desc' => 'Send log data to both the Cacti log file and the System log facility',
    'syslog_only' => 'Syslog Only',
    'syslog_only_desc' => 'Send select log data to just the System log facility',
    'log_destination_note' => 'This setting is quite self explanatory, when it comes to what type of messages are sent to the System log facility, see the Syslog/Eventlog Item Selection section below.',
    'general_log_level' => 'General Log Level',
    'general_log_level_desc' => 'This is the level of logging that Cacti will use. Options include:',
    'log_level_none' => 'NONE',
    'log_level_none_desc' => 'Don\'t perform any logging, not recommended.',
    'log_level_low' => 'LOW',
    'log_level_low_desc' => 'Statistics and Errors',
    'log_level_medium' => 'MEDIUM',
    'log_level_medium_desc' => 'Statistics, Errors and Results',
    'log_level_high' => 'HIGH',
    'log_level_high_desc' => 'Statistics, Errors, Results and Major I/O Events',
    'log_level_debug' => 'DEBUG',
    'log_level_debug_desc' => 'Statistics, Errors, Results, I/O and Program Flow',
    'log_level_devel' => 'DEVEL',
    'log_level_devel_desc' => 'Developer level messages, mainly SQL Queries',
    'log_level_advice' => 'Select the log level that works best for your logging needs. Be advised that DEBUG generates a large amount of log data. DEVEL should only log SQL Queries.',
    'log_input_validation' => 'Log Input Validation Issues',
    'log_input_validation_desc' => 'This is a Developer option to log the use of request variables that have not been validated through Cacti\'s validation functions.',
    'data_source_tracing' => 'Data Source Tracing',
    'data_source_tracing_desc' => 'This is a debug options for logging of program flow around the creation of Data Sources.',
    'selective_file_debug' => 'Selective File Debug',
    'selective_file_debug_desc' => 'A Multi-select setting that allows you to place any Cacti file to be placed into debug mode. This prevents the cacti.log file from being flooded with messages as is common in a general debug context.',
    'selective_plugin_debug' => 'Selective Plugin Debug',
    'selective_plugin_debug_desc' => 'For Plugins, the same level of debug that is available for core Cacti files are available for Plugin files as well.',
    'device_debug' => 'Device Debug',
    'device_debug_desc' => 'This is a comma delimited list of Cacti device_id that debugging of Data Collection services will be enabled for.',
    'syslog_eventlog_selection' => 'Syslog/Eventlog Item Selection',
    'syslog_eventlog_selection_desc' => 'In order to not saturate the System logging facility, Cacti will only forward some events as defined by the various check-boxes.',

    // Internationalization Settings
    'internationalization_intro' => 'The image below shows system level Internationalization settings for Cacti, commonly referred to as i18n.',
    'internationalization_settings' => 'Internationalization Settings',
    'i18n_settings_include' => 'Those settings include:',
    'language_support' => 'Language Support',
    'language_support_desc' => 'Whether or not to allow selecting other languages for Cacti',
    'language' => 'Language',
    'language_desc' => 'The default language to use at login time, or by default when the user has not specified a language.',
    'auto_language_detection' => 'Auto Language Detection',
    'auto_language_detection_desc' => 'Whether or not Cacti should read the language from the browser and use that language by default.',
    'preferred_language_processor' => 'Preferred Language Processor',
    'preferred_language_processor_desc' => 'Some PHP distributions doe not come with the php-gettext module. In those cases, the various Linux distributions come with alternate GetText processors. You can select the one that works best for your environment here.',
    'date_display_format' => 'Date Display Format',
    'date_display_format_desc' => 'The default Date/Time display format.',
    'date_separator' => 'Date Separator',
    'date_separator_desc' => 'The default Data/Time separator character.',

    // Other Settings
    'other_settings_intro' => 'These are additional settings for Cacti that fall into various categories, but that done have enough entries to justify a separate section. The image below shows that sub-section.',
    'other_settings_include' => 'Those settings include:',
    'has_graphs_data_sources_checked' => 'Has Graphs/Data Sources Checked',
    'has_graphs_data_sources_checked_desc' => 'If from the Console, you enter a pages that has the various Has options, if checked here, the default will be to check that setting.',
    'rrdtool_version' => 'RRDtool Version',
    'rrdtool_version_desc' => 'Selecting the correct RRDtool Version will unlock features expected in modern graphing frameworks that leverage SVG (Canvas) rendering.',
    'graph_permission_method' => 'Graph Permission Method',
    'graph_permission_method_desc' => 'This defined if a user needs to have access to both a Device and Graph Template to view a Devices Graphs, otherwise known as Restrictive or that to view a Devices Graphs the user only needs either the Device or Graph Template permission.',
    'graph_data_source_creation_method' => 'Graph/Data Source Creation Method',
    'graph_data_source_creation_method_desc' => 'If you wish to only create Graphs from Graph Templates choose the Simple method. The Advanced method should only be used by people who wish to define individual Graphs with their own settings.',
    'show_form_setting_help_inline' => 'Show Form/Setting Help Inline',
    'show_form_setting_help_inline_desc' => 'If this option is checked, you will be able to read all form/setting help inline. Otherwise, you will receive a pop-up to access form help.',
    'delete_verification' => 'Delete Verification',
    'delete_verification_desc' => 'For simple object removal, things that can be removed by clicking and \'X\' on the page, whether or not you wish to confirm those deletes.',
    'data_source_preservation_preset' => 'Data Source Preservation Preset',
    'data_source_preservation_preset_desc' => 'Whether or not you wish to preserve Data Sources by default, or remove them when deleting Graphs. In all cases, Cacti will not allow the removal of a Data Source if there are Graphs using the Data Source. However, some Data Sources are managed externally to Cacti, and removing those Data Sources by default may not be desired.',
    'graph_auto_unlock' => 'Graph Auto Unlock',
    'graph_auto_unlock_desc' => 'If when editing a Graph you wish to always unlock it by default, select this option. Not that this does have performance implications that may make the User Interface slower on vary large systems where devices have tens of thousands of Data Sources.',
    'hide_cacti_dashboard' => 'Hide Cacti Dashboard',
    'hide_cacti_dashboard_desc' => 'This is an option used by some plugin developers who replace the default Cacti Console with their own contents, for example the Intropage plugin.',
    'enable_drag_n_drop' => 'Enable Drag-N-Drop',
    'enable_drag_n_drop_desc' => 'Certain Cacti pages allow Drag-N-Drop. If you with to use it, check that option.',

    // Site Security Settings
    'site_security_intro' => 'The image below shows Site Security settings for Cacti.',
    'site_security_include' => 'Those settings include:',
    'force_connections_https' => 'Force Connections over HTTPS',
    'force_connections_https_desc' => 'Even if the web site allows http, redirect their browsers to HTTPS.',
    'content_security_unsafe_javascript' => 'Content-Security Allow Unsafe JavaScript eval() calls',
    'content_security_unsafe_javascript_desc' => 'Allow plugins to use the JavaScript eval() function call, which is historically unsafe. However, some older plugins require it.',
    'content_security_alternate_sources' => 'Content-Security Alternate Sources',
    'content_security_alternate_sources_desc' => 'If for some reason your Cacti site requires content from a CDN or a third party site, you can include a space delimited list of URLs that will be able to be traversed for Cacti content.',

    // Automation Settings
    'automation_settings_intro' => 'The image below shows general Automation Settings for Cacti.',
    'automation_settings_include' => 'Those settings include:',
    'enable_automatic_graph_creation' => 'Enable Automatic Graph Creation',
    'enable_automatic_graph_creation_desc' => 'If a Cacti Device has Non Data Query Graph Templates associated with it, create those Graphs automatically when adding a new Device. Additionally, if you have Graph Rules apply those at Device creation time and save time.',
    'enable_automatic_tree_item_creation' => 'Enable Automatic Tree Item Creation',
    'enable_automatic_tree_item_creation_desc' => 'If you have Cacti Tree Rules apply then at Device creation and save time.',
    'automation_notification_to_email' => 'Automation Notification To Email',
    'automation_notification_to_email_desc' => 'When Network Automation finishes, send a notification to this Email address.',
    'automation_notification_from_name' => 'Automation Notification From Name',
    'automation_notification_from_name_desc' => 'The From Name on the Automation Email.',
    'automation_from_email' => 'Automation From Email',
    'automation_from_email_desc' => 'The From Email such as noreply@cacti.net that will be used for Automation notifications.',

    // Graph Template Defaults
    'graph_template_defaults_intro' => 'This is where Cacti obtains defaults for Graph Templates.',
    'graph_template_image_format' => 'Graph Template Image Format',
    'graph_template_image_format_desc' => 'When creating a new Graph Template what Image Format should be used. There is either:',
    'svg_format' => 'SVG',
    'svg_format_desc' => 'Scalable Vector Graphs (preferred, though larger size)',
    'png_format' => 'PNG',
    'png_format_desc' => 'Petri Net Graphs (backup, smaller but loose resolution when scaled)',
    'graph_template_height' => 'Graph Template Height',
    'graph_template_height_desc' => 'The height in pixels of the Graph Canvas for new Graph Templates',
    'graph_template_width' => 'Graph Template Width',
    'graph_template_width_desc' => 'The width in pixels of the Graph Canvas for new Graph Templates',

    // Basic page titles and content for converted HTML files
    'page_title_settings_paths' => 'Cacti - Settings Paths',
    'settings_paths_title' => 'Settings Paths',
    'settings_paths_intro' => 'This section describes the path settings in Cacti.',
    'settings_paths_description' => 'Path settings define where Cacti can find various external programs and files.',
    'settings_paths_note' => 'Please ensure all paths are correctly configured for your system.',

    'page_title_user_management' => 'Cacti - User Management',
    'user_management_title' => 'User Management',
    'user_management_intro' => 'This section describes user management in Cacti.',
    'user_management_description' => 'User management allows you to create, modify, and delete user accounts.',
    'user_management_note' => 'Proper user management is essential for system security.',

    'page_title_frequently_asked_questions' => 'Cacti - Frequently Asked Questions',
    'frequently_asked_questions_title' => 'Frequently Asked Questions',
    'frequently_asked_questions_intro' => 'This section contains frequently asked questions about Cacti.',
    'frequently_asked_questions_description' => 'Find answers to common questions and troubleshooting tips.',
    'frequently_asked_questions_note' => 'If you cannot find your answer here, please check the community forums.',

    // Authentication Settings Pages
    'page_title_settings_auth_local' => 'Cacti - Local Authentication Settings',
    'settings_auth_local_title' => 'Local Authentication Settings',
    'settings_auth_local_intro' => 'This section describes local authentication settings in Cacti.',
    'settings_auth_local_description' => 'Local authentication allows users to authenticate using Cacti\'s internal user database.',
    'local_auth_settings' => 'Local Authentication Settings',
    'local_auth_settings_intro' => 'Configure local authentication parameters:',
    'guest_user' => 'Guest User',
    'guest_user_desc' => 'Enable guest user access to Cacti',
    'user_template' => 'User Template',
    'user_template_desc' => 'Default template for new users',
    'minimum_password_length' => 'Minimum Password Length',
    'minimum_password_length_desc' => 'Minimum required password length',
    'force_password_change' => 'Force Password Change',
    'force_password_change_desc' => 'Force users to change password on first login',
    'password_history' => 'Password History',
    'password_history_desc' => 'Number of previous passwords to remember',
    'security_settings' => 'Security Settings',
    'security_settings_intro' => 'Configure security parameters:',
    'account_lockout' => 'Account Lockout',
    'account_lockout_desc' => 'Enable account lockout after failed attempts',
    'lockout_duration' => 'Lockout Duration',
    'lockout_duration_desc' => 'Duration of account lockout in minutes',
    'failed_attempts' => 'Failed Attempts',
    'failed_attempts_desc' => 'Number of failed attempts before lockout',
    'session_timeout' => 'Session Timeout',
    'session_timeout_desc' => 'Session timeout in minutes',

    'page_title_settings_auth_ldap' => 'Cacti - LDAP Authentication Settings',
    'settings_auth_ldap_title' => 'LDAP Authentication Settings',
    'settings_auth_ldap_intro' => 'This section describes LDAP authentication settings in Cacti.',
    'settings_auth_ldap_description' => 'LDAP authentication allows users to authenticate using an external LDAP directory.',
    'ldap_server_settings' => 'LDAP Server Settings',
    'ldap_server_settings_intro' => 'Configure LDAP server connection parameters:',
    'ldap_server' => 'LDAP Server',
    'ldap_server_desc' => 'LDAP server hostname or IP address',
    'ldap_port' => 'LDAP Port',
    'ldap_port_desc' => 'LDAP server port number',
    'ldap_protocol_version' => 'LDAP Protocol Version',
    'ldap_protocol_version_desc' => 'LDAP protocol version to use',
    'ldap_encryption' => 'LDAP Encryption',
    'ldap_encryption_desc' => 'Encryption method for LDAP connections',
    'ldap_referrals' => 'LDAP Referrals',
    'ldap_referrals_desc' => 'Enable or disable LDAP referrals',
    'ldap_authentication' => 'LDAP Authentication',
    'ldap_authentication_intro' => 'Configure LDAP authentication parameters:',
    'ldap_dn' => 'LDAP DN',
    'ldap_dn_desc' => 'LDAP distinguished name template',
    'ldap_group_require' => 'LDAP Group Require',
    'ldap_group_require_desc' => 'Require group membership for authentication',
    'ldap_group_dn' => 'LDAP Group DN',
    'ldap_group_dn_desc' => 'LDAP group distinguished name',
    'ldap_group_attrib' => 'LDAP Group Attribute',
    'ldap_group_attrib_desc' => 'LDAP group membership attribute',
    'ldap_group_member_type' => 'LDAP Group Member Type',
    'ldap_group_member_type_desc' => 'Type of group membership attribute',

    // Basic Auth and Domains
    'page_title_settings_auth_basic' => 'Cacti - Basic Authentication Settings',
    'settings_auth_basic_title' => 'Basic Authentication Settings',
    'settings_auth_basic_intro' => 'This section describes basic authentication settings in Cacti.',
    'settings_auth_basic_description' => 'Basic authentication uses web server authentication mechanisms.',
    'basic_auth_settings' => 'Basic Authentication Settings',
    'basic_auth_settings_intro' => 'Configure basic authentication parameters:',
    'basic_auth_enabled' => 'Basic Auth Enabled',
    'basic_auth_enabled_desc' => 'Enable basic authentication',
    'basic_auth_header' => 'Basic Auth Header',
    'basic_auth_header_desc' => 'HTTP header containing username',
    'basic_auth_username' => 'Basic Auth Username',
    'basic_auth_username_desc' => 'Username field in authentication header',
    'basic_auth_password' => 'Basic Auth Password',
    'basic_auth_password_desc' => 'Password field in authentication header',
    'web_server_config' => 'Web Server Configuration',
    'web_server_config_intro' => 'Configure web server for basic authentication:',
    'apache_config' => 'Apache Configuration',
    'apache_config_desc' => 'Apache web server configuration for basic auth',
    'nginx_config' => 'Nginx Configuration',
    'nginx_config_desc' => 'Nginx web server configuration for basic auth',
    'iis_config' => 'IIS Configuration',
    'iis_config_desc' => 'IIS web server configuration for basic auth',

    'page_title_settings_domains' => 'Cacti - Domain Settings',
    'settings_domains_title' => 'Domain Settings',
    'settings_domains_intro' => 'This section describes domain settings in Cacti.',
    'settings_domains_description' => 'Domains allow multiple authentication realms within Cacti.',
    'domain_configuration' => 'Domain Configuration',
    'domain_configuration_intro' => 'Configure domain parameters:',
    'domain_name' => 'Domain Name',
    'domain_name_desc' => 'Name of the authentication domain',
    'domain_type' => 'Domain Type',
    'domain_type_desc' => 'Type of domain authentication',
    'domain_enabled' => 'Domain Enabled',
    'domain_enabled_desc' => 'Enable this domain for authentication',
    'domain_delinked' => 'Domain Delinked',
    'domain_delinked_desc' => 'Delink domain from user accounts',
    'ldap_domain_settings' => 'LDAP Domain Settings',
    'ldap_domain_settings_intro' => 'Configure LDAP-specific domain parameters:',
    'ldap_domain_server' => 'LDAP Domain Server',
    'ldap_domain_server_desc' => 'LDAP server for this domain',
    'ldap_domain_port' => 'LDAP Domain Port',
    'ldap_domain_port_desc' => 'LDAP port for this domain',
    'ldap_domain_dn' => 'LDAP Domain DN',
    'ldap_domain_dn_desc' => 'LDAP distinguished name for this domain',
    'ldap_domain_proto_version' => 'LDAP Domain Protocol Version',
    'ldap_domain_proto_version_desc' => 'LDAP protocol version for this domain',

    // System Utilities
    'page_title_system_utilities' => 'Cacti - System Utilities',
    'system_utilities_title' => 'System Utilities',
    'system_utilities_intro' => 'This section describes system utilities in Cacti.',
    'system_utilities_description' => 'System utilities provide maintenance and troubleshooting tools.',
    'technical_support' => 'Technical Support',
    'technical_support_intro' => 'Tools for technical support and troubleshooting:',
    'technical_support_log' => 'Technical Support Log',
    'technical_support_log_desc' => 'Generate technical support log for troubleshooting',
    'technical_support_summary' => 'Technical Support Summary',
    'technical_support_summary_desc' => 'Generate system summary for support',
    'system_maintenance' => 'System Maintenance',
    'system_maintenance_intro' => 'System maintenance and cleanup tools:',
    'rebuild_poller_cache' => 'Rebuild Poller Cache',
    'rebuild_poller_cache_desc' => 'Rebuild the poller cache for all devices',
    'rebuild_resource_cache' => 'Rebuild Resource Cache',
    'rebuild_resource_cache_desc' => 'Rebuild the resource cache',
    'clear_user_log' => 'Clear User Log',
    'clear_user_log_desc' => 'Clear the user activity log',
    'clear_logfile' => 'Clear Log File',
    'clear_logfile_desc' => 'Clear the main Cacti log file',
    'database_utilities' => 'Database Utilities',
    'database_utilities_intro' => 'Database maintenance tools:',
    'database_repair' => 'Database Repair',
    'database_repair_desc' => 'Repair database tables',
    'database_optimize' => 'Database Optimize',
    'database_optimize_desc' => 'Optimize database tables',
    'database_backup' => 'Database Backup',
    'database_backup_desc' => 'Create database backup',

    // Data Debug
    'page_title_data_debug' => 'Cacti - Data Debug',
    'data_debug_title' => 'Data Debug',
    'data_debug_intro' => 'This section describes data debugging in Cacti.',
    'data_debug_description' => 'Data debug tools help troubleshoot data collection issues.',
    'debug_data_sources' => 'Debug Data Sources',
    'debug_data_sources_intro' => 'Debug data source collection:',
    'data_source_debug' => 'Data Source Debug',
    'data_source_debug_desc' => 'Debug individual data sources',
    'rrd_file_debug' => 'RRD File Debug',
    'rrd_file_debug_desc' => 'Debug RRD file operations',
    'poller_output_debug' => 'Poller Output Debug',
    'poller_output_debug_desc' => 'Debug poller output data',
    'debug_graphs' => 'Debug Graphs',
    'debug_graphs_intro' => 'Debug graph generation:',
    'graph_debug' => 'Graph Debug',
    'graph_debug_desc' => 'Debug graph generation process',
    'graph_image_debug' => 'Graph Image Debug',
    'graph_image_debug_desc' => 'Debug graph image creation',
    'rrdtool_debug' => 'RRDtool Debug',
    'rrdtool_debug_desc' => 'Debug RRDtool command execution',
    'debug_devices' => 'Debug Devices',
    'debug_devices_intro' => 'Debug device communication:',
    'device_debug' => 'Device Debug',
    'device_debug_desc' => 'Debug device data collection',
    'snmp_debug' => 'SNMP Debug',
    'snmp_debug_desc' => 'Debug SNMP communication',
    'ping_debug' => 'Ping Debug',
    'ping_debug_desc' => 'Debug device ping operations',

    // External Links
    'page_title_external_links' => 'Cacti - External Links',
    'external_links_title' => 'External Links',
    'external_links_intro' => 'This section describes external links in Cacti.',
    'external_links_description' => 'External links provide quick access to related tools and resources.',
    'link_management' => 'Link Management',
    'link_management_intro' => 'Manage external links:',
    'add_external_link' => 'Add External Link',
    'add_external_link_desc' => 'Add a new external link',
    'edit_external_link' => 'Edit External Link',
    'edit_external_link_desc' => 'Edit an existing external link',
    'delete_external_link' => 'Delete External Link',
    'delete_external_link_desc' => 'Delete an external link',
    'link_configuration' => 'Link Configuration',
    'link_configuration_intro' => 'Configure link properties:',
    'link_title' => 'Link Title',
    'link_title_desc' => 'Display title for the link',
    'link_url' => 'Link URL',
    'link_url_desc' => 'Target URL for the link',
    'link_style' => 'Link Style',
    'link_style_desc' => 'Display style for the link',
    'link_enabled' => 'Link Enabled',
    'link_enabled_desc' => 'Enable or disable the link',
    'link_categories' => 'Link Categories',
    'link_categories_intro' => 'Different types of external links:',
    'console_links' => 'Console Links',
    'console_links_desc' => 'Links displayed in the console',
    'graph_links' => 'Graph Links',
    'graph_links_desc' => 'Links displayed on graph pages',
    'device_links' => 'Device Links',
    'device_links_desc' => 'Links displayed on device pages',

    // Reports Admin
    'page_title_reports_admin' => 'Cacti - Reports Administration',
    'reports_admin_title' => 'Reports Administration',
    'reports_admin_intro' => 'This section describes report administration in Cacti.',
    'reports_admin_description' => 'Report administration allows managing automated reports.',
    'report_management' => 'Report Management',
    'report_management_intro' => 'Manage reports:',
    'create_report' => 'Create Report',
    'create_report_desc' => 'Create a new report',
    'edit_report' => 'Edit Report',
    'edit_report_desc' => 'Edit an existing report',
    'delete_report' => 'Delete Report',
    'delete_report_desc' => 'Delete a report',
    'duplicate_report' => 'Duplicate Report',
    'duplicate_report_desc' => 'Create a copy of an existing report',
    'report_scheduling' => 'Report Scheduling',
    'report_scheduling_intro' => 'Configure report scheduling:',
    'schedule_frequency' => 'Schedule Frequency',
    'schedule_frequency_desc' => 'How often the report should run',
    'schedule_time' => 'Schedule Time',
    'schedule_time_desc' => 'When the report should run',
    'schedule_recipients' => 'Schedule Recipients',
    'schedule_recipients_desc' => 'Who should receive the report',
    'schedule_format' => 'Schedule Format',
    'schedule_format_desc' => 'Format of the scheduled report',
    'report_templates' => 'Report Templates',
    'report_templates_intro' => 'Manage report templates:',
    'template_management' => 'Template Management',
    'template_management_desc' => 'Create and manage report templates',
    'template_customization' => 'Template Customization',
    'template_customization_desc' => 'Customize report template appearance',
    'template_sharing' => 'Template Sharing',
    'template_sharing_desc' => 'Share templates with other users',

    // Reports User
    'page_title_reports_user' => 'Cacti - Reports User Interface',
    'reports_user_title' => 'Reports User Interface',
    'reports_user_intro' => 'This section describes the user interface for reports in Cacti.',
    'reports_user_description' => 'The reports user interface allows viewing and managing personal reports.',
    'viewing_reports' => 'Viewing Reports',
    'viewing_reports_intro' => 'View and access reports:',
    'report_list' => 'Report List',
    'report_list_desc' => 'View list of available reports',
    'report_preview' => 'Report Preview',
    'report_preview_desc' => 'Preview reports before downloading',
    'report_download' => 'Report Download',
    'report_download_desc' => 'Download reports in various formats',
    'report_email' => 'Report Email',
    'report_email_desc' => 'Email reports to recipients',
    'report_subscriptions' => 'Report Subscriptions',
    'report_subscriptions_intro' => 'Manage report subscriptions:',
    'subscribe_report' => 'Subscribe to Report',
    'subscribe_report_desc' => 'Subscribe to receive automated reports',
    'unsubscribe_report' => 'Unsubscribe from Report',
    'unsubscribe_report_desc' => 'Unsubscribe from automated reports',
    'subscription_preferences' => 'Subscription Preferences',
    'subscription_preferences_desc' => 'Configure subscription preferences',
    'report_history' => 'Report History',
    'report_history_intro' => 'Access historical reports:',
    'historical_reports' => 'Historical Reports',
    'historical_reports_desc' => 'View previously generated reports',
    'report_archive' => 'Report Archive',
    'report_archive_desc' => 'Access archived reports',
    'report_search' => 'Report Search',
    'report_search_desc' => 'Search through report history',

    // Settings Pages - Path Settings
    'page_title_settings_paths' => 'Cacti - Path Settings',
    'path_settings_title' => 'Path Settings',
    'path_settings_intro' => 'Path Settings in Cacti consist of the following categories:',
    'required_tool_paths' => 'Required Tool Paths',
    'required_tool_paths_desc' => 'Paths to external tools required by Cacti',
    'logging' => 'Logging',
    'logging_desc' => 'Log file locations and rotation settings',
    'alternate_poller_path' => 'Alternate Poller Path',
    'alternate_poller_path_desc' => 'Settings for the Spine poller',
    'rrd_cleaner' => 'RRD Cleaner',
    'rrd_cleaner_desc' => 'Automatic cleanup of unused RRD files',
    'remote_data_collectors_note' => 'Note that for Remote Data Collectors, these paths are set on the Remote Data Collector and not on the Main Cacti server.',

    // Required Tools Paths
    'required_tools_paths' => 'Required Tools Paths',
    'required_tools_paths_intro' => 'Cacti requires several external tools to function properly. The paths to these tools must be configured correctly.',
    'required_tools_paths_include' => 'The required tools include:',
    'snmpwalk_binary_path' => 'snmpwalk Binary Path',
    'snmpwalk_binary_path_desc' => 'The path to the snmpwalk binary',
    'snmpget_binary_path' => 'snmpget Binary Path',
    'snmpget_binary_path_desc' => 'The path to the snmpget binary',
    'snmpbulkwalk_binary_path' => 'snmpbulkwalk Binary Path',
    'snmpbulkwalk_binary_path_desc' => 'The path to the snmpbulkwalk binary',
    'snmpgetnext_binary_path' => 'snmpgetnext Binary Path',
    'snmpgetnext_binary_path_desc' => 'The path to the snmpgetnext binary',
    'snmptrap_binary_path' => 'snmptrap Binary Path',
    'snmptrap_binary_path_desc' => 'The path to the snmptrap binary',
    'rrdtool_binary_path' => 'RRDtool Binary Path',
    'rrdtool_binary_path_desc' => 'The path to the RRDtool binary',
    'php_binary_path' => 'PHP Binary Path',
    'php_binary_path_desc' => 'The path to the PHP binary',

    // Logging Settings
    'logging_intro' => 'Configure log file locations and rotation settings.',
    'logfile_settings' => 'Log File Settings',
    'logging_settings_include' => 'The logging settings include:',
    'cacti_log_path' => 'Cacti Log Path',
    'cacti_log_path_desc' => 'The path to the main Cacti log file',
    'poller_stderr_log_path' => 'Poller STDERR Log Path',
    'poller_stderr_log_path_desc' => 'The path to the poller error log file',
    'rotate_cacti_log' => 'Rotate Cacti Log',
    'rotate_cacti_log_desc' => 'Enable automatic log rotation',
    'rotation_frequency' => 'Rotation Frequency',
    'rotation_frequency_desc' => 'How often to rotate the log files',
    'log_retention' => 'Log Retention',
    'log_retention_desc' => 'How many rotated log files to keep',
    'package_maintainers_note' => 'Package maintainers should ensure that log rotation is handled by the system log rotation facility.',

    // Alternate Poller Path
    'alternate_poller_path_intro' => 'Configure settings for the Spine poller.',
    'alternate_poller_path_settings_include' => 'The alternate poller path settings include:',
    'spine_binary_file_location' => 'Spine Binary File Location',
    'spine_binary_file_location_desc' => 'The path to the Spine binary',
    'spine_config_file_path' => 'Spine Config File Path',
    'spine_config_file_path_desc' => 'The path to the Spine configuration file. Options include:',
    'pwd' => 'PWD',
    'pwd_desc' => 'Use the current working directory',
    'etc_sibling' => '/etc (sibling)',
    'etc_sibling_desc' => 'Use the /etc directory as a sibling to the binary',
    'etc_system' => '/etc (system)',
    'etc_system_desc' => 'Use the system /etc directory',

    // RRD Cleaner
    'rrd_cleaner_intro' => 'Configure automatic cleanup of unused RRD files.',
    'rrd_cleaner_settings_include' => 'The RRD cleaner settings include:',
    'rrdfile_auto_clean' => 'RRD File Auto Clean',
    'rrdfile_auto_clean_desc' => 'Enable automatic cleanup of unused RRD files',
    'rrdfile_auto_clean_method' => 'RRD File Auto Clean Method',
    'rrdfile_auto_clean_method_desc' => 'Method to use for cleaning unused RRD files:',
    'delete' => 'Delete',
    'delete_desc' => 'Permanently delete unused RRD files',
    'archive' => 'Archive',
    'archive_desc' => 'Move unused RRD files to an archive directory',
    'archive_directory' => 'Archive Directory',
    'archive_directory_desc' => 'Directory to store archived RRD files',

    // Settings Pages - Device Defaults
    'page_title_settings_device_defaults' => 'Cacti - Device Default Settings',
    'device_default_settings_title' => 'Device Default Settings',
    'device_default_settings_intro' => 'Device Default Settings are used when adding devices to Cacti through various methods:',
    'manual' => 'Manual',
    'manual_desc' => 'Adding devices manually through the web interface',
    'cli' => 'CLI',
    'cli_desc' => 'Adding devices through command line scripts',
    'automation' => 'Automation',
    'automation_desc' => 'Adding devices through automation discovery',
    'device_defaults_purpose' => 'These defaults help streamline the device addition process by providing sensible default values.',

    // General Defaults
    'general_defaults_intro' => 'General device default settings apply to all new devices.',
    'general_defaults_include' => 'The general defaults include:',
    'template' => 'Template',
    'template_desc' => 'Default device template to use for new devices',
    'site' => 'Site',
    'site_desc' => 'Default site assignment for new devices',
    'poller' => 'Poller',
    'poller_desc' => 'Default data collector for new devices',
    'device_threads' => 'Device Threads',
    'device_threads_desc' => 'Number of threads to use for this device',
    'reindex_method' => 'Reindex Method',
    'reindex_method_desc' => 'Method to use for reindexing data queries',
    'default_interface_speed' => 'Default Interface Speed',
    'default_interface_speed_desc' => 'Default speed for network interfaces',
    'device_threads_note' => 'Device threads are only applicable when using the Spine poller.',

    // SNMP Defaults
    'snmp_defaults_intro' => 'SNMP default settings for new devices.',
    'snmp_defaults_include' => 'The SNMP defaults include:',
    'version' => 'Version',
    'version_desc' => 'SNMP version to use (1, 2c, or 3)',
    'community' => 'Community',
    'community_desc' => 'SNMP community string for v1/v2c',
    'port_number' => 'Port Number',
    'port_number_desc' => 'SNMP port number (usually 161)',
    'timeout' => 'Timeout',
    'timeout_desc' => 'SNMP timeout in milliseconds',
    'retries' => 'Retries',
    'retries_desc' => 'Number of SNMP retries',
    'security_level' => 'Security Level',
    'security_level_desc' => 'SNMP v3 security level',
    'auth_protocol' => 'Auth Protocol',
    'auth_protocol_desc' => 'SNMP v3 authentication protocol',
    'auth_user' => 'Auth User',
    'auth_user_desc' => 'SNMP v3 authentication username',
    'auth_password' => 'Auth Password',
    'auth_password_desc' => 'SNMP v3 authentication password',
    'privacy_protocol' => 'Privacy Protocol',
    'privacy_protocol_desc' => 'SNMP v3 privacy protocol',
    'privacy_passphrase' => 'Privacy Passphrase',
    'privacy_passphrase_desc' => 'SNMP v3 privacy passphrase',
    'snmp_context' => 'SNMP Context',
    'snmp_context_desc' => 'SNMP v3 context',
    'snmp_engine_id' => 'SNMP Engine ID',
    'snmp_engine_id_desc' => 'SNMP v3 engine ID',

    // Availability/Reachability
    'availability_reachability' => 'Availability/Reachability',
    'availability_reachability_intro' => 'Configure how Cacti determines if a device is up or down.',
    'availability_reachability_desc' => 'These settings determine how Cacti checks device availability.',
    'availability_options_include' => 'The availability options include:',
    'downed_device_detection' => 'Downed Device Detection',
    'downed_device_detection_desc' => 'Method to use for detecting down devices:',
    'none' => 'None',
    'none_desc' => 'Do not check device availability',
    'ping_and_snmp_uptime' => 'Ping and SNMP Uptime',
    'ping_and_snmp_uptime_desc' => 'Device must respond to both ping and SNMP',
    'ping_or_snmp_uptime' => 'Ping or SNMP Uptime',
    'ping_or_snmp_uptime_desc' => 'Device must respond to either ping or SNMP',
    'snmp_uptime' => 'SNMP Uptime',
    'snmp_uptime_desc' => 'Check device uptime via SNMP',
    'snmp_desc' => 'SNMP Desc',
    'snmp_desc_desc' => 'Check device description via SNMP',
    'snmp_getnext' => 'SNMP GetNext',
    'snmp_getnext_desc' => 'Use SNMP GetNext operation',
    'ping' => 'Ping',
    'ping_desc' => 'Use ping to check device availability',
    'ping_type' => 'Ping Type',
    'ping_type_desc' => 'Type of ping to use (ICMP, UDP, TCP)',
    'ping_port' => 'Ping Port',
    'ping_port_desc' => 'Port to use for TCP/UDP ping',
    'ping_timeout_value' => 'Ping Timeout Value',
    'ping_timeout_value_desc' => 'Ping timeout in milliseconds',
    'ping_retry_count' => 'Ping Retry Count',
    'ping_retry_count_desc' => 'Number of ping retries',

    // Up/Down Settings
    'up_down_settings' => 'Up/Down Settings',
    'up_down_settings_intro' => 'Configure device up/down state management.',

    // Settings Pages - Poller Settings
    'page_title_settings_poller' => 'Cacti - Poller Settings',
    'poller_settings_title' => 'Poller Settings',
    'poller_settings_intro' => 'Poller Settings control how Cacti collects data from devices.',

    // General Settings
    'general_settings' => 'General Settings',
    'general_settings_intro' => 'General poller configuration options.',
    'settings_poller_general' => 'General Poller Settings',
    'general_settings_include' => 'The general settings include:',
    'data_collection_enabled' => 'Data Collection Enabled',
    'data_collection_enabled_desc' => 'Enable or disable data collection',
    'snmp_agent_support_enabled' => 'SNMP Agent Support Enabled',
    'snmp_agent_support_enabled_desc' => 'Enable SNMP agent functionality',
    'poller_type' => 'Poller Type',
    'poller_type_desc' => 'Type of poller to use (cmd.php or spine)',
    'poller_sync_interval' => 'Poller Sync Interval',
    'poller_sync_interval_desc' => 'How often to sync poller cache',
    'poller_interval' => 'Poller Interval',
    'poller_interval_desc' => 'How often to run the poller (in seconds)',
    'poller_interval_note' => 'The poller interval should match your cron job frequency.',
    'cron_daemon_interval' => 'Cron Daemon Interval',
    'cron_daemon_interval_desc' => 'Interval for the cron daemon',
    'balance_process_load' => 'Balance Process Load',
    'balance_process_load_desc' => 'Balance load across multiple processes',
    'debug_output_width' => 'Debug Output Width',
    'debug_output_width_desc' => 'Width of debug output in characters',
    'disable_decreasing_oid_check' => 'Disable Decreasing OID Check',
    'disable_decreasing_oid_check_desc' => 'Disable checking for decreasing OIDs',
    'remote_agent_timeout' => 'Remote Agent Timeout',
    'remote_agent_timeout_desc' => 'Timeout for remote agent connections',
    'snmp_bulkwalk_fetch_size' => 'SNMP Bulkwalk Fetch Size',
    'snmp_bulkwalk_fetch_size_desc' => 'Number of OIDs to fetch per bulkwalk request',
    'snmp_bulkwalk_note' => 'Larger fetch sizes can improve performance but may cause timeouts.',
    'snmp_get_oid_limit' => 'SNMP Get OID Limit',
    'snmp_get_oid_limit_desc' => 'Maximum number of OIDs per SNMP get request',
    'disable_resource_cache_replication' => 'Disable Resource Cache Replication',
    'disable_resource_cache_replication_desc' => 'Disable replication of resource cache',

    // Background Timeout Settings
    'background_timeout_settings' => 'Background Timeout Settings',
    'background_timeout_settings_intro' => 'Configure timeouts for background processes.',
    'background_timeout_settings_include' => 'The background timeout settings include:',
    'report_generation_timeout' => 'Report Generation Timeout',
    'report_generation_timeout_desc' => 'Timeout for report generation in seconds',
    'data_source_statistics_timeout' => 'Data Source Statistics Timeout',
    'data_source_statistics_timeout_desc' => 'Timeout for data source statistics in seconds',
    'background_commands_timeout' => 'Background Commands Timeout',
    'background_commands_timeout_desc' => 'Timeout for background commands in seconds',
    'maintenance_background_generation_timeout' => 'Maintenance Background Generation Timeout',
    'maintenance_background_generation_timeout_desc' => 'Timeout for maintenance tasks in seconds',
    'spikekill_background_generation_timeout' => 'Spikekill Background Generation Timeout',
    'spikekill_background_generation_timeout_desc' => 'Timeout for spikekill processing in seconds',

    // Data Collector Defaults
    'data_collector_defaults' => 'Data Collector Defaults',
    'data_collector_defaults_intro' => 'Default settings for data collectors.',
    'data_collector_defaults_desc' => 'These settings apply to all data collectors unless overridden.',
    'data_collector_defaults_include' => 'The data collector defaults include:',
    'data_collector_processes' => 'Data Collector Processes',
    'data_collector_processes_desc' => 'Number of data collector processes to run',
    'threads_per_process' => 'Threads per Process',
    'threads_per_process_desc' => 'Number of threads per data collector process',
    'threads_per_process_note' => 'More threads can improve performance but increase memory usage.',

    // Additional Spine Parameters
    'additional_spine_parameters' => 'Additional Spine Parameters',
    'additional_spine_parameters_intro' => 'Additional configuration options for the Spine poller.',
    'additional_spine_parameters_include' => 'The additional Spine parameters include:',
    'invalid_data_logging' => 'Invalid Data Logging',
    'invalid_data_logging_desc' => 'Enable logging of invalid data',
    'number_of_php_script_servers' => 'Number of PHP Script Servers',
    'number_of_php_script_servers_desc' => 'Number of PHP script servers to run',
    'script_and_script_server_timeout_value' => 'Script and Script Server Timeout Value',
    'script_and_script_server_timeout_value_desc' => 'Timeout for scripts and script servers in seconds',

    // Settings Pages - Visual Settings
    'page_title_settings_visual' => 'Cacti - Visual Settings',
    'visual_settings_title' => 'Visual Settings',
    'overview' => 'Overview',
    'visual_settings_overview' => 'Visual Settings in Cacti consist of the following categories:',
    'visual_settings_subsections' => 'Each of these settings will be documented below.',
    'plugin_developers_note' => 'Plugin developers should note that many of these settings can be overridden by plugins.',

    // Theme, Table, Tree and Filter Settings
    'theme_table_tree_filter_settings' => 'Theme, Table, Tree and Filter Settings',
    'theme_table_tree_filter_intro' => 'These settings control the visual appearance and behavior of the Cacti interface.',
    'settings_visual_theme_table_tree_filter' => 'Theme, Table, Tree and Filter Settings',
    'theme_table_tree_filter_include' => 'The theme, table, tree and filter settings include:',
    'theme' => 'Theme',
    'theme_desc' => 'The visual theme to use for the Cacti interface',
    'rows_per_page' => 'Rows per Page',
    'rows_per_page_desc' => 'Default number of rows to display per page in tables',
    'auto_complete_enabled' => 'Auto Complete Enabled',
    'auto_complete_enabled_desc' => 'Enable auto-completion in form fields',
    'auto_complete_rows' => 'Auto Complete Rows',
    'auto_complete_rows_desc' => 'Number of rows to display in auto-complete dropdowns',
    'minimum_tree_width' => 'Minimum Tree Width',
    'minimum_tree_width_desc' => 'Minimum width of the tree navigation panel',
    'maximum_tree_width' => 'Maximum Tree Width',
    'maximum_tree_width_desc' => 'Maximum width of the tree navigation panel',
    'strip_domains_from_device_dropdowns' => 'Strip Domains from Device Dropdowns',
    'strip_domains_from_device_dropdowns_desc' => 'Remove domain names from device dropdown lists',

    // Graph, Data Source, Data Query, Log Settings
    'graph_data_source_data_query_log_settings' => 'Graph, Data Source, Data Query, Log Settings',
    'graph_data_source_data_query_log_intro' => 'These settings control how graphs, data sources, and logs are displayed.',
    'graph_data_source_data_query_log_include' => 'The graph, data source, data query, and log settings include:',
    'maximum_title_length' => 'Maximum Title Length',
    'maximum_title_length_desc' => 'Maximum length of graph and data source titles',
    'data_source_field_length' => 'Data Source Field Length',
    'data_source_field_length_desc' => 'Maximum length of data source field names',
    'default_graph_type' => 'Default Graph Type',
    'default_graph_type_desc' => 'Default type for new graphs',
    'default_log_tail_lines' => 'Default Log Tail Lines',
    'default_log_tail_lines_desc' => 'Number of lines to display when viewing log files',
    'maximum_number_of_rows_per_page' => 'Maximum Number of Rows per Page',
    'maximum_number_of_rows_per_page_desc' => 'Maximum number of rows that can be displayed per page',
    'log_tail_refresh' => 'Log Tail Refresh',
    'log_tail_refresh_desc' => 'How often to refresh log tail displays',
    'exclusion_regex' => 'Exclusion Regex',
    'exclusion_regex_desc' => 'Regular expression to exclude lines from log displays',

    // Realtime and RRDtool Graph Options
    'realtime_and_rrdtool_graph_options' => 'Realtime and RRDtool Graph Options',
    'realtime_and_rrdtool_graph_intro' => 'These settings control realtime graphing and RRDtool options.',
    'realtime_and_rrdtool_graph_include' => 'The realtime and RRDtool graph options include:',
    'enable_realtime_graphing' => 'Enable Realtime Graphing',
    'enable_realtime_graphing_desc' => 'Enable realtime graph generation',
    'graph_timespan' => 'Graph Timespan',
    'graph_timespan_desc' => 'Default timespan for realtime graphs',
    'refresh_interval' => 'Refresh Interval',
    'refresh_interval_desc' => 'How often to refresh realtime graphs',
    'cacti_directory' => 'Cacti Directory',
    'cacti_directory_desc' => 'Directory path for Cacti installation',
    'custom_watermark' => 'Custom Watermark',
    'custom_watermark_desc' => 'Custom watermark text for graphs',
    'disable_rrdtool_watermark' => 'Disable RRDtool Watermark',
    'disable_rrdtool_watermark_desc' => 'Disable the default RRDtool watermark',
    'font_selection_method' => 'Font Selection Method',
    'font_selection_method_desc' => 'Method to use for font selection in graphs',
    'rrdtool_watermark_note' => 'Disabling the RRDtool watermark may affect graph appearance.',

    // Font Selection Options
    'font_selection_options' => 'Font Selection Options',
    'font_selection_options_intro' => 'Configure font options for graph generation.',
    'font_selection_options_desc' => 'Font selection options allow customization of graph text appearance.',

    // Settings Pages - Performance Settings (Boost)
    'page_title_settings_performance' => 'Cacti - Performance Settings (Boost)',
    'performance_settings_boost_title' => 'Performance Settings (Boost)',
    'performance_settings_intro' => 'Performance Settings in Cacti are primarily related to the Boost plugin functionality.',
    'performance_settings_cpu_benefits' => 'These settings can provide significant CPU and I/O performance benefits for large Cacti installations.',
    'performance_settings_detailed_guide' => 'For a more detailed guide on Boost configuration, please refer to the',
    'advanced_topics' => 'Advanced Topics',
    'please_refer_to_guide' => 'Please refer to that guide for comprehensive setup instructions.',

    // On Demand RRD Update Settings
    'on_demand_rrd_update_settings' => 'On Demand RRD Update Settings',
    'on_demand_rrd_update_intro' => 'On Demand RRD Update settings control how Boost handles RRD file updates.',
    'boost_on_demand_settings' => 'Boost On Demand Settings',
    'on_demand_settings_include' => 'The on demand settings include:',
    'enable_on_demand_rrd_updating' => 'Enable On Demand RRD Updating',
    'enable_on_demand_rrd_updating_desc' => 'Enable the Boost on demand RRD updating feature',
    'how_often_should_boost_update_all_rrds' => 'How Often Should Boost Update All RRDs',
    'how_often_should_boost_update_all_rrds_desc' => 'Frequency for updating all RRD files',
    'number_of_boost_processes' => 'Number of Boost Processes',
    'number_of_boost_processes_desc' => 'Number of parallel processes for Boost operations',
    'maximum_records' => 'Maximum Records',
    'maximum_records_desc' => 'Maximum number of records to process per Boost cycle',
    'maximum_data_sources_items_per_pass' => 'Maximum Data Sources Items per Pass',
    'maximum_data_sources_items_per_pass_desc' => 'Maximum number of data source items to process per pass',
    'maximum_argument_length' => 'Maximum Argument Length',
    'maximum_argument_length_desc' => 'Maximum length of command line arguments for RRDtool',
    'memory_limit_for_boost_and_poller' => 'Memory Limit for Boost and Poller',
    'memory_limit_for_boost_and_poller_desc' => 'Memory limit for Boost and poller processes',
    'maximum_rrd_update_script_run_time' => 'Maximum RRD Update Script Run Time',
    'maximum_rrd_update_script_run_time_desc' => 'Maximum time allowed for RRD update scripts',
    'enable_direct_population_of_poller_output_boost_table' => 'Enable Direct Population of Poller Output Boost Table',
    'enable_direct_population_of_poller_output_boost_table_desc' => 'Enable direct population of the Boost table from poller output',
    'boost_debug_log' => 'Boost Debug Log',
    'boost_debug_log_desc' => 'Enable debug logging for Boost operations',

    // Image Caching
    'image_caching' => 'Image Caching',
    'image_caching_intro' => 'Image caching settings control how Cacti handles graph image caching.',
    'image_caching_explanation' => 'Image caching can significantly improve performance by storing pre-generated graph images.',

    // Settings Pages - Spike Kill Settings
    'page_title_settings_spikes' => 'Cacti - Spike Kill Settings',
    'spike_kill_title' => 'Spike Kill',
    'spike_kill_intro' => 'Spike Kill is a feature that helps remove data spikes from RRD files.',
    'spike_kill_causes' => 'Data spikes can be caused by various factors including network issues, device reboots, or data collection problems.',
    'spike_kill_gaps' => 'These spikes can create gaps in data or unrealistic values that affect graph readability.',

    // Spike Kill Settings
    'spike_kill_settings' => 'Spike Kill Settings',
    'spike_kill_settings_intro' => 'Configure how Cacti detects and handles data spikes.',
    'settings_spike_kill' => 'Spike Kill Settings',
    'spike_kill_settings_include' => 'The spike kill settings include:',
    'removal_method' => 'Removal Method',
    'removal_method_desc' => 'Method to use for detecting and removing spikes',
    'replacement_method' => 'Replacement Method',
    'replacement_method_desc' => 'Method to use for replacing removed spike values',
    'number_of_standard_deviations' => 'Number of Standard Deviations',
    'number_of_standard_deviations_desc' => 'Number of standard deviations to use for spike detection',
    'variance_percentage' => 'Variance Percentage',
    'variance_percentage_desc' => 'Percentage variance threshold for spike detection',
    'variance_number_of_outliers' => 'Variance Number of Outliers',
    'variance_number_of_outliers_desc' => 'Number of outliers to consider for variance calculation',
    'max_kills_per_rra' => 'Max Kills per RRA',
    'max_kills_per_rra_desc' => 'Maximum number of spikes to remove per RRA',
    'rrdfile_backup_directory' => 'RRD File Backup Directory',
    'rrdfile_backup_directory_desc' => 'Directory to store backup copies of modified RRD files',

    // Batch Spike Kill Settings
    'batch_spike_kill_settings' => 'Batch Spike Kill Settings',
    'batch_spike_kill_settings_intro' => 'Configure batch processing options for spike kill operations.',
    'settings_spike_kill_batch' => 'Batch Spike Kill Settings',
    'batch_spike_kill_note' => 'Batch spike kill operations can be resource intensive and should be scheduled during low usage periods.',

    // Settings Pages - Mail/Reporting/DNS Settings
    'page_title_settings_mail_reporting_dns' => 'Cacti - Mail/Reporting/DNS Settings',
    'mail_reporting_dns_settings_title' => 'Mail/Reporting/DNS Settings',
    'mail_reporting_dns_settings_intro' => 'Mail/Reporting/DNS Settings control email notifications, reporting, and DNS resolution in Cacti.',

    // URL Linking
    'url_linking' => 'URL Linking',
    'url_linking_intro' => 'Configure URL linking options for Cacti.',
    'url_linking_settings' => 'URL Linking Settings',

    // Mail Settings
    'mail_settings' => 'Mail Settings',
    'mail_settings_intro' => 'Cacti supports three different mail services for sending notifications and reports:',
    'php_mail_function' => 'PHP Mail Function',
    'php_mail_function_desc' => 'Use the built-in PHP mail() function',
    'sendmail_binary' => 'Sendmail Binary',
    'sendmail_binary_desc' => 'Use the system sendmail binary',
    'simple_mail_transfer_protocol_smtp' => 'Simple Mail Transfer Protocol (SMTP)',
    'simple_mail_transfer_protocol_smtp_desc' => 'Use SMTP for mail delivery',
    'mail_settings_details' => 'Each mail service has its own configuration options and requirements.',

    // Emailing Options
    'emailing_options' => 'Emailing Options',
    'emailing_options_intro' => 'General email configuration options for Cacti.',
    'emailing_options_include' => 'The emailing options include:',
    'notify_primary_admin_of_issues' => 'Notify Primary Admin of Issues',
    'notify_primary_admin_of_issues_desc' => 'Send email notifications to the primary administrator for system issues',
    'test_email' => 'Test Email',
    'test_email_desc' => 'Email address to use for testing mail configuration',
    'mail_services' => 'Mail Services',
    'mail_services_desc' => 'Select the mail service to use for sending emails',
    'ping_mail_server' => 'Ping Mail Server',
    'ping_mail_server_desc' => 'Test connectivity to the mail server before sending',
    'from_email_address' => 'From Email Address',
    'from_email_address_desc' => 'Email address to use as the sender',
    'from_name' => 'From Name',
    'from_name_desc' => 'Display name to use as the sender',
    'word_wrap' => 'Word Wrap',
    'word_wrap_desc' => 'Number of characters per line for email word wrapping',
    'mail_services_documentation' => 'Each mail service has specific configuration requirements as documented below.',

    // PHP Mail Function Settings
    'php_mail_function_settings' => 'The PHP Mail Function is the simplest option but requires proper system mail configuration.',

    // Sendmail Binary Settings
    'sendmail_binary_settings' => 'The Sendmail Binary option allows you to specify a custom sendmail binary path.',

    // SMTP Settings
    'smtp_settings_intro' => 'The SMTP Mail Services provider offers the most options and is familiar to administrators. Popular services like Google and Microsoft are supported through the PHP-Mailer plugin.',
    'smtp_mail' => 'SMTP Mail',
    'smtp_options_include' => 'The SMTP options include:',
    'smtp_hostname' => 'SMTP Hostname',
    'smtp_hostname_desc' => 'The hostname or DNS name of the SMTP server',
    'smtp_port' => 'SMTP Port',
    'smtp_port_desc' => 'The TCP port to use for SMTP communication',
    'smtp_username' => 'SMTP Username',
    'smtp_username_desc' => 'Username for SMTP authentication if required',
    'smtp_password' => 'SMTP Password',
    'smtp_password_desc' => 'Password for SMTP authentication if required',
    'smtp_security' => 'SMTP Security',
    'smtp_security_desc' => 'Security protocol for SMTP (None, SSL, TLS)',
    'smtp_timeout' => 'SMTP Timeout',
    'smtp_timeout_desc' => 'Timeout for SMTP connection attempts',

    // Reporting Presets
    'reporting_presets' => 'Reporting Presets',
    'reporting_presets_intro' => 'Cacti Reporting can generate large email attachments. Reporting Presets allow you to control traffic and set image type and logging presets.',
    'reporting_presets_note' => 'These settings are straightforward and control report generation parameters.',

    // DNS Options
    'dns_options' => 'DNS Options',
    'dns_options_intro' => 'DNS Options allow you to specify primary and secondary DNS servers for plugin DNS operations.',
    'dns_options_desc' => 'Many plugins can use their own DNS options. For plugins requiring alternate DNS settings, refer to their specific documentation.'
);
?>
