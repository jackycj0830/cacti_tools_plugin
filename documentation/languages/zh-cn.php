...
chmod u+s /usr/local/spine/bin/spine',
    ...
    'settings_without_auth' => '设置（无身份验证）',
    'settings_general' => '常规',
    'settings_paths' => '路径',
    'settings_device_defaults' => '设备默认值',
    'settings_poller' => '轮询器',
    ...
    'settings_performance' => '性能',
    'settings_spikes' => '峰值',
    'settings_mail_reporting_dns' => '邮件/报告/DNS',
    'settings_auth' => '设置 - 身份验证',
    'settings_auth_local' => '本地身份验证',
    'settings_auth_ldap' => 'LDAP 身份验证',
    'settings_auth_basic' => '基本身份验证',
    'settings_domains' => '域身份验证',
    'configuration_users_groups_domains' => '配置 - 用户、组和域',
    'user_management' => '用户',
    'user_group_management' => '用户组',
    'user_domains' => '用户域',
    'configuration_plugins' => '配置 - 插件',
    'utilities' => '实用工具',
    'system_utilities' => '系统实用工具',
    'data_debug' => '数据调试',
    'external_links' => '外部链接',
    ...
    'reports_preview' => '报告预览页面',
    'reports_events' => '报告事件页面',
    'reports_other_options' => '添加报告项目的其他选项',
    'cacti_log' => 'Cacti 日志',
    'command_line_scripts' => '命令行脚本',
    'php_script_server' => 'PHP 脚本服务器',
    'boost' => '性能设置（Boost）',
    'frequently_asked_questions' => '常见问题',
    'replacement_variables' => '替换变量',
    'rrdtool_specific_features' => 'RRDtool 特定功能',
    'rrdproxy_specific_features' => 'RRDProxy 特定功能',
    'spikekill' => 'Spikekill',
    'debugging' => '调试',
    'version_specific_release_notes' => '版本特定发布说明',
    'plugin_overview' => '插件概述',
    'plugin_guidelines' => '插件指南',
    'creating_plugins' => '创建插件',
    'plugin_references' => '参考',
    'plugin_hook_api_ref' => '钩子 API 参考',
    'supported_plugins' => '支持的插件',
    'syslog_plugin' => 'Syslog 插件文档',
    'mactrack_plugin' => 'Mactrack 插件文档',
    'reportit_plugin' => 'ReportIt 插件文档',

    // How To's section
    'how_to_work_with_templates' => '如何使用模板',
    'how_to_create_data_input_method' => '如何创建数据输入方法',
    'how_to_data_queries' => '如何使用数据查询',
    'how_to_existing_snmp_data_queries' => '如何使用现有 SNMP 数据查询',
    'how_to_new_snmp_data_queries' => '如何使用新 SNMP 数据查询',
    'how_to_script_data_queries' => '如何使用脚本数据查询',
    'how_to_setup_remote_pollers' => '如何设置远程轮询器',
    'how_to_determine_template_version' => '如何确定模板版本',
    'how_to_ssh_tunnels' => '如何设置 SSH 隧道',
    'enable_ssl_for_cacti' => '为 Cacti 启用 SSL',
    'graph_single_snmp_oid' => '绘制单个 SNMP OID 图形',
    'how_to_snmp_custom_script' => '如何使用自定义脚本/数据扩展 snmpd',
    'how_to_poller_5_to_1_min' => '将轮询间隔从 5 分钟更改为 1 分钟',
    'convert_package_to_source' => '在 Ubuntu/Debian 上从基于包的安装转换为源码安装',

    // Video Tutorials
    'video_tutorials' => '视频教程',
    'video_tutorials_desc' => '如果您愿意，可以在 Cacti 官方 YouTube 页面上观看操作指南和教程。如果您有任何视频想法或想要贡献，请告诉我们！',
    'cacti_youtube_channel' => 'Cacti 官方 YouTube 频道',

    // Contributing section
    'open_source_code' => '开源代码',
    'language_translations' => '语言翻译',

    // Development Standards
    'standards_documentation' => '文档',
    'standards_code_formatting' => '代码格式',
    'standards_php_spec_constructs' => 'PHP 特定构造',
    'standards_filesystem_layout' => '文件系统布局',
    'standards_patch_creation' => '补丁创建',
    'standards_sql' => 'SQL 标准',
    'standards_security' => '安全',

    // Template Specific Documentation
    'template_specific_documentation' => '模板特定文档',
    'template_specific_desc' => '本节将用于模板特定配置要求',
    'apache_server_template' => 'Apache 服务器模板',
    'esxi_vmware_template' => 'ESXi/VMWare 模板',
