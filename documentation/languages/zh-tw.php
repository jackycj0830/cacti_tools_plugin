...
chmod u+s /usr/local/spine/bin/spine',
    ...
    'settings_without_auth' => '設定（無身份驗證）',
    'settings_general' => '一般',
    'settings_paths' => '路徑',
    'settings_device_defaults' => '裝置預設值',
    'settings_poller' => '輪詢器',
    ...
    'settings_performance' => '效能',
    'settings_spikes' => '峰值',
    'settings_mail_reporting_dns' => '郵件/報告/DNS',
    'settings_auth' => '設定 - 身份驗證',
    'settings_auth_local' => '本地身份驗證',
    'settings_auth_ldap' => 'LDAP 身份驗證',
    'settings_auth_basic' => '基本身份驗證',
    'settings_domains' => '網域身份驗證',
    'configuration_users_groups_domains' => '配置 - 使用者、群組和網域',
    'user_management' => '使用者',
    'user_group_management' => '使用者群組',
    'user_domains' => '使用者網域',
    'configuration_plugins' => '配置 - 外掛',
    'utilities' => '實用工具',
    'system_utilities' => '系統實用工具',
    'data_debug' => '資料除錯',
    'external_links' => '外部連結',
    ...
    'reports_preview' => '報告預覽頁面',
    'reports_events' => '報告事件頁面',
    'reports_other_options' => '新增報告項目的其他選項',
    'cacti_log' => 'Cacti 日誌',
    'command_line_scripts' => '命令列腳本',
    'php_script_server' => 'PHP 腳本伺服器',
    'boost' => '效能設定（Boost）',
    ...
    'spikekill' => 'Spikekill',
    'debugging' => '除錯',
    'version_specific_release_notes' => '版本特定發布說明',
    'plugin_overview' => '外掛概述',
    'plugin_guidelines' => '外掛指南',
    'creating_plugins' => '建立外掛',
    'plugin_references' => '參考',
    'plugin_hook_api_ref' => '鉤子 API 參考',
    'supported_plugins' => '支援的外掛',
    'syslog_plugin' => 'Syslog 外掛文件',
    'mactrack_plugin' => 'Mactrack 外掛文件',
    'reportit_plugin' => 'ReportIt 外掛文件',

    // How To's section
    'how_to_work_with_templates' => '如何使用範本',
    'how_to_create_data_input_method' => '如何建立資料輸入方法',
    'how_to_data_queries' => '如何使用資料查詢',
    'how_to_existing_snmp_data_queries' => '如何使用現有 SNMP 資料查詢',
    'how_to_new_snmp_data_queries' => '如何使用新 SNMP 資料查詢',
    'how_to_script_data_queries' => '如何使用腳本資料查詢',
    'how_to_setup_remote_pollers' => '如何設定遠端輪詢器',
    'how_to_determine_template_version' => '如何確定範本版本',
    'how_to_ssh_tunnels' => '如何設定 SSH 隧道',
    'enable_ssl_for_cacti' => '為 Cacti 啟用 SSL',
    'graph_single_snmp_oid' => '繪製單個 SNMP OID 圖形',
    'how_to_snmp_custom_script' => '如何使用自訂腳本/資料擴展 snmpd',
    'how_to_poller_5_to_1_min' => '將輪詢間隔從 5 分鐘更改為 1 分鐘',
    'convert_package_to_source' => '在 Ubuntu/Debian 上從基於套件的安裝轉換為原始碼安裝',

    // Video Tutorials
    'video_tutorials' => '影片教學',
    'video_tutorials_desc' => '如果您願意，可以在 Cacti 官方 YouTube 頁面上觀看操作指南和教學。如果您有任何影片想法或想要貢獻，請告訴我們！',
    'cacti_youtube_channel' => 'Cacti 官方 YouTube 頻道',

    // Contributing section
    'open_source_code' => '開源程式碼',
    'language_translations' => '語言翻譯',

    // Development Standards
    'standards_documentation' => '文件',
    'standards_code_formatting' => '程式碼格式',
    'standards_php_spec_constructs' => 'PHP 特定構造',
    'standards_filesystem_layout' => '檔案系統佈局',
    'standards_patch_creation' => '補丁建立',
    'standards_sql' => 'SQL 標準',
    'standards_security' => '安全',

    // Template Specific Documentation
    'template_specific_documentation' => '範本特定文件',
    'template_specific_desc' => '本節將用於範本特定配置要求',
    'apache_server_template' => 'Apache 伺服器範本',
    'esxi_vmware_template' => 'ESXi/VMWare 範本',

    // Additional missing keys
    'other_advanced_topics' => '其他進階主題',
    'plugin_management' => '外掛管理',

    // Basic page titles and content for converted HTML files
    'page_title_settings_paths' => 'Cacti - 設定路徑',
    'settings_paths_title' => '設定路徑',
    'settings_paths_intro' => '本節描述 Cacti 中的路徑設定。',
    'settings_paths_description' => '路徑設定定義 Cacti 可以找到各種外部程式和檔案的位置。',
    'settings_paths_note' => '請確保所有路徑都為您的系統正確配置。',

    'page_title_user_management' => 'Cacti - 使用者管理',
    'user_management_title' => '使用者管理',
    'user_management_intro' => '本節描述 Cacti 中的使用者管理。',
    'user_management_description' => '使用者管理允許您建立、修改和刪除使用者帳戶。',
    'user_management_note' => '正確的使用者管理對系統安全至關重要。',

    'page_title_frequently_asked_questions' => 'Cacti - 常見問題',
    'frequently_asked_questions_title' => '常見問題',
    'frequently_asked_questions_intro' => '本節包含有關 Cacti 的常見問題。',
    'frequently_asked_questions_description' => '查找常見問題的答案和故障排除提示。',
    'frequently_asked_questions_note' => '如果您在這裡找不到答案，請查看社群論壇。'
);
?>
