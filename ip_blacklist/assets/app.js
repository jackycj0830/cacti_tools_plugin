...
function renderBatchResultWithFilter(data, filter, sortBy, sortDir) {
    ...
    return `
        <div class="batch-summary-enhanced">
            <div class="batch-stat-card total" onclick="filterBatchResults('all')">
            ...
            <div class="batch-stat-card blocked" onclick="filterBatchResults('blocked')">
                <div class="stat-icon">🚫</div>
                <div class="stat-content">
            ...
            <div class="batch-stat-card safe" onclick="filterBatchResults('safe')">
                <div class="stat-icon">✅</div>
                <div class="stat-content">
            ...
            <div class="batch-stat-card high-risk" onclick="filterBatchResults('high')">
                <div class="stat-icon">🔴</div>
                <div class="stat-content">
            ...
            <div class="batch-stat-card medium-risk" onclick="filterBatchResults('medium')">
                <div class="stat-icon">🟡</div>
                <div class="stat-content">
            ...
            <div class="batch-stat-card low-risk" onclick="filterBatchResults('low')">
                <div class="stat-icon">🟢</div>
                <div class="stat-content">
        ...
        <div class="batch-table-container">
            <table class="batch-results-table" id="batchTable">
                <thead>
                    <tr>
                        <th class="sortable" onclick="sortBatchResults('ip')">${t('ip')} ${getSortIcon('ip')}</th>
                        <th class="sortable" onclick="sortBatchResults('status')">${t('status')} ${getSortIcon('status')}</th>
                        <th class="sortable" onclick="sortBatchResults('country')">${t('country')} ${getSortIcon('country')}</th>
                        <th>ISP</th>
                        <th class="sortable" onclick="sortBatchResults('score')">Score ${getSortIcon('score')}</th>
                        <th class="sortable" onclick="sortBatchResults('risk')">Risk ${getSortIcon('risk')}</th>
                        <th>Threat Type</th>
                    </tr>
                </thead>
