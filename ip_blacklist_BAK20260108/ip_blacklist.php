...
<body>
    <div class="container">
        ...
        <div class="tabs">
            ...
            <button class="tab" onclick="switchTab('batch')" data-i18n="batch_query">批量查詢本地黑IP</button>
        ...
        <div class="panel hidden" id="batchPanel">
            <div class="query-form">
                <textarea id="batchInput" placeholder="每行一個IP地址，最多100個" class="batch-input" rows="6"></textarea>
