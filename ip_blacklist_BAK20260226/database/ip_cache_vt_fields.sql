...
-- ============================================================================
-- MySQL: ALTER TABLE ip_cache — Add VirusTotal fields
-- ============================================================================
ALTER TABLE ip_cache ADD COLUMN vt_malicious INT DEFAULT NULL COMMENT 'VT: malicious vendor count';
ALTER TABLE ip_cache ADD COLUMN vt_suspicious INT DEFAULT NULL COMMENT 'VT: suspicious vendor count';
ALTER TABLE ip_cache ADD COLUMN vt_harmless INT DEFAULT NULL COMMENT 'VT: harmless vendor count';
ALTER TABLE ip_cache ADD COLUMN vt_undetected INT DEFAULT NULL COMMENT 'VT: undetected vendor count';
ALTER TABLE ip_cache ADD COLUMN vt_detection_flagged INT DEFAULT NULL COMMENT 'VT: flagged count (malicious + suspicious)';
ALTER TABLE ip_cache ADD COLUMN vt_detection_total INT DEFAULT NULL COMMENT 'VT: total vendors queried';
ALTER TABLE ip_cache ADD COLUMN vt_link VARCHAR(255) DEFAULT NULL COMMENT 'VT: VirusTotal report URL';
ALTER TABLE ip_cache ADD COLUMN vt_queried_at DATETIME DEFAULT NULL COMMENT 'VT: last query timestamp';
...
-- ============================================================================
-- SQLite: ALTER TABLE ip_cache — Add VirusTotal fields
-- ============================================================================
-- ALTER TABLE ip_cache ADD COLUMN vt_malicious INTEGER DEFAULT NULL;
-- ALTER TABLE ip_cache ADD COLUMN vt_suspicious INTEGER DEFAULT NULL;
-- ALTER TABLE ip_cache ADD COLUMN vt_harmless INTEGER DEFAULT NULL;
-- ALTER TABLE ip_cache ADD COLUMN vt_undetected INTEGER DEFAULT NULL;
-- ALTER TABLE ip_cache ADD COLUMN vt_detection_flagged INTEGER DEFAULT NULL;
-- ALTER TABLE ip_cache ADD COLUMN vt_detection_total INTEGER DEFAULT NULL;
-- ALTER TABLE ip_cache ADD COLUMN vt_link TEXT DEFAULT NULL;
-- ALTER TABLE ip_cache ADD COLUMN vt_queried_at TEXT DEFAULT NULL;
